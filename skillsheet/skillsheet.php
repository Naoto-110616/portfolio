                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="sentence">
                                株式会社ダスキン（派遣）<br>
                                【業務内容】<br>
                                ミスタードーナツ店舗、事業部、工場のインターネット監視、お客様へ<br>
                                機器の接続確認及び、説明、壊れた機器の交換手配。<br>

                                【取り組み・実績】<br>
                                対応は全て電話でのみの対応になるので、お客様へ具体的に理解しやすく<br>
                                説明することを心がけました。<br>
                                障害が起きない限りは、することが無いのでIT言語の勉強をする時間にしていました。</td>
                            <td>-</td>
                            <td>-</td>
                            <td>8名</td>
                        </tr>
                        ...
                        <tr>
                            <td class= "sentence" colspan="7">【人物面】<br>
                                ...
                                　取材やアンケート、許可取得でも様々な方との折衝業務もこなしてきましたのでコミュニケーション能力もとても高く、また21歳とはおもえないほど<br>
                                　社会人としてのマナーや話し方がしっかり備わっております。<br>

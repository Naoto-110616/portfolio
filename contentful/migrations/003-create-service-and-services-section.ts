...
const migration: MigrationFunction = (migration) => {
	...
	service.createField("sortOrder").name("Sort order").type("Integer").required(true);
	...
	servicesSection.createField("title").name("Section title").type("Symbol").required(true);

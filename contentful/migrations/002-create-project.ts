...
const migration: MigrationFunction = (migration) => {
	...
	project.createField("description").name("Description").type("Text").required(true);

	project.createField("partner").name("Partner").type("Symbol").required(true);

	project.createField("publishedYear").name("Published year").type("Symbol").required(true);
	...
	project.createField("thumbnail").name("Thumbnail").type("Link").linkType("Asset").required(true);

	project.createField("externalUrl").name("External URL").type("Symbol").required(true);

	project.createField("featuredOnHome").name("Featured on home").type("Boolean").required(false);
	...
	project.createField("sortOrder").name("Sort order").type("Integer").required(true);

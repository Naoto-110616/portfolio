...
const migration: MigrationFunction = (migration) => {
  ...
  homePage
    .createField("chatTitle")
    .name("Chat title")
    .type("Symbol")
    .required(true);

  homePage
    .createField("chatDescription")
    .name("Chat description")
    .type("Text")
    .required(true);

  homePage
    .createField("chatHelperText")
    .name("Chat helper text")
    .type("Text")
    .required(true);

  homePage
    .createField("chatPlaceholder")
    .name("Chat placeholder")
    .type("Symbol")
    .required(true);

  homePage
    .createField("workSectionTitle")
    .name("Work section title")
    .type("Symbol")
    .required(true);
